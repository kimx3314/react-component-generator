export const GOOGLE_MODELS = ['gemini-3.1-flash-lite', 'gemini-3.5-flash'];

export const SYSTEM_PROMPT = `You are a React component generator. Generate a single React component based on the user's description.
